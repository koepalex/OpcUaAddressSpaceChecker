...
public static class RuleReferenceCatalog
{
    ...
    private static IReadOnlyDictionary<string, RuleReference> BuildCatalog()
    {
        ...
        return new Dictionary<string, RuleReference>(StringComparer.Ordinal)
        {
            ...
            ["GEN-05"] = new("Move the child to the declared path, model it through a placeholder, or exclude the rule if intentional.", CoreSpec("6.4.4")),
            ...
            ["GEN-12"] = new("Add the missing Method or argument property declared by the type model.", CoreSpec("5.7")),
