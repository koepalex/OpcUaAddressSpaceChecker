...
public class CertificateManager
{
    ...
    /// <param name="pkiRoot">Optional custom PKI root directory. Defaults to ~/.opcua-check-address-space/pki</param>
        ...
        string applicationUri)
    {
        var certificateIdentifier = new CertificateIdentifier
        {
            ...
            SubjectName = $"CN={applicationName}, O=OpcUaAddressSpaceChecker, DC={Environment.MachineName}"
        };
        ...
        var certificate = CertificateFactory.CreateCertificate(
            applicationUri,
            applicationName,
            $"CN={applicationName}, O=OpcUaAddressSpaceChecker, DC={Environment.MachineName}",
            null)
